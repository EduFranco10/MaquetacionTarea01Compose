    ...
    Column(
        ...
        val contentModifier =
            if (isLandscape) Modifier
                .fillMaxWidth().padding(16.dp) else Modifier.fillMaxHeight()
        LazyColumn(
    ...
    Row(
        ...
        Button(
            ...
            colors = ButtonDefaults.buttonColors(
                containerColor = if (isEnabled && isDarkTheme) Color(0xFF7D208D) else if (isEnabled) Color(0xFF6200EE) else Color(0xFF9E9E9E),
...
fun ViewOutlinedTextField(
    ...
    OutlinedTextField(
        ...
        modifier = Modifier.background(if (isDarkTheme) Color.DarkGray else Color.White),
        label = {
            Text(
                text = labelText,
                fontSize = 16.sp,
